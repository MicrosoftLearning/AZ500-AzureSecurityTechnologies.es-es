...
6. En la pestaña Recursos, selecciona **+ Agregar recursos,** marca **Habilitar puntos de conexión de recopilación de datos.** En la plantilla Seleccionar un ámbito, activa **AZ500LAB131415** y haz clic en **Aplicar**.

---
lab:
  title: 05 - Grupos de seguridad de red y grupos de seguridad de aplicaciones
  module: Module 02 - Implement Platform Protection
---

# Laboratorio 05: Grupos de seguridad de red y grupos de seguridad de aplicaciones
...
3. En la hoja **myVMWeb**, en la sección **Redes**, haz clic en **Configuración de redes** y, a continuación, en la hoja **myVMWeb \| Configuración de redes**, haz clic en la pestaña **Grupos de seguridad de aplicaciones**.

4. Haz clic en **Añadir grupos de seguridad de aplicaciones** y, en la lista **Grupo de seguridad de aplicaciones**, selecciona **myAsgWebServers** y haz clic en **Guardar**.

5. Vuelva a la hoja **Máquinas virtuales** y, en la lista de máquinas virtuales, haga clic en la entrada **myVMMgmt**.

6. En la hoja **myVMMgmt**, en la sección **Redes**, haz clic en **Configuración de redes** y, a continuación, en la hoja **myVMMgmt \| Configuración de redes**, haz clic en la pestaña **Grupos de seguridad de aplicaciones**.

7. Haz clic en **Añadir grupos de seguridad de aplicaciones** y, en la lista **Grupo de seguridad de aplicaciones**, selecciona **myAsgMgmtServers** y haz clic en **Guardar**.
...
5. En la hoja **myVMWeb**, en la sección **Carga**, haz clic en **Ejecutar comando** y, a continuación, en **RunPowerShellScript**.

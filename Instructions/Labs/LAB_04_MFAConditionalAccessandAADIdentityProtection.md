...
1. En Azure Portal, use el cuadro de texto **Buscar recursos, servicios y documentos** y, en la parte superior de la página, escriba **Implementar una plantilla personalizada**.
...
1. En la hoja **Implementación personalizada**, haga clic en la opción **Cree su propia plantilla en el editor**.

1. En la hoja **Editar plantilla**, haga clic en **Cargar archivo**, busque el archivo **\\Allfiles\\Labs\\04\\az-500-04_azuredeploy.json** y haga clic en **Abrir**.
...
1. En la hoja **Editar plantilla**, haga clic en **Guardar**.

1. De nuevo en la hoja **Implementación personalizada**, haga clic en **Editar parámetros**.

1. En la hoja **Editar parámetros**, haga clic en **Cargar archivo**, busque el archivo **\\ Allfiles\\Labs\\04\\az-500-04_azuredeploy.parameters.json** y haga clic en **Abrir**.

    >**Nota**: Revise el contenido del archivo de parámetros y observe los valores de adminUsername y adminPassword.

1. En la hoja **Editar parámetros**, haga clic en **Guardar**.
...
1. En la pestaña **Aspectos básicos** de la hoja **Creación de un inquilino**, asegúrese de que la opción **Azure Active Directory** está seleccionada y haga clic en **Siguiente: Configuración >** .
...
2. Agregue el código captcha en la hoja **Help us prove you're not a robot** (Ayúdenos a demostrar que no es un robot) y, a continuación, haga clic en el botón **Enviar**. 
...
1. En la hoja **Directorio y suscripción**, haga clic en el inquilino recién creado, **AdatumLab500-04**.
...
1. En la hoja **AdatumLab500-04**, en la sección **Administrar**, haga clic en **Licencias**.

1. En la hoja **Licencias \| Información general**, en la sección **Administrar**, haga clic en **Todos los productos** y, a continuación, en **+ Probar o comprar**.

1. En la hoja **Activar**, en la sección Azure AD Premium P2, haga clic en **Evaluación gratuita** y, a continuación, en **Activar**.
...
1. En la hoja **Nuevo usuario**, asegúrese de que la opción **Crear usuario** está seleccionada y, a continuación, especifique la siguiente configuración (deje la otra configuración con sus valores predeterminados) y haga clic en **Crear**:
...
1. De nuevo en la hoja **Usuarios \| Todos los usuarios**, haga clic en **+ Nuevo usuario**. 

1. En la hoja **Nuevo usuario**, asegúrese de que la opción **Crear usuario** está seleccionada y, a continuación, especifique la siguiente configuración (deje la otra configuración con sus valores predeterminados):
...
1. Haga clic en **Nuevo usuario**, complete las nuevas opciones de configuración de usuario y, a continuación, haga clic en **Crear**.
...
1. En la hoja que muestra las propiedades de la cuenta de usuario, haga clic en **Editar**. 

1. Vuelva a la hoja **AdatumLab500-04**  Azure Active Directory y, en la sección **Administrar**, haga clic en **Licencias**.

1. En la hoja **Licencias \| Información general**, haga clic en **Todos los productos**, active la casilla **Azure Active Directory Premium P2** y haga clic en **+ Asignar**.

1. En la hoja **Asignar licencias** haga clic en **+ Agregar usuarios y grupos**.

1. En la hoja **Usuarios**, seleccione **aaduser1**, **aaduser2**, **aaduser3** y su cuenta de usuario, y haga clic en **Seleccionar**.

1. De nuevo en hoja **Asignar licencias**, haga clic en **Opciones de asignación**, asegúrese de que todas las opciones están habilitadas, haga clic en **Review + assign** (Revisar y asignar) y luego en **Asignar**.

1. Cierre la sesión de Azure Portal y vuelva a iniciarla con la misma cuenta. Este paso es necesario para que la asignación de licencias surta efecto.
...
1. En la hoja **AdatumLab500-04** del inquilino de Azure Active Directory, en la sección **Administrar**, haga clic en **Seguridad**.

1. En la hoja **Seguridad \| Introducción**, en la sección **Administrar**, haga clic en **MFA**.

1. En la hoja **Multi-Factor Authentication \| Introducción**, haga clic en el vínculo **Configuración adicional de MFA basado en la nube**. 

    >**Nota**: Se abrirá una nueva pestaña del explorador, que muestra la página **Multi-Factor Authentication**.

1. En la página **Multi-Factor Authentication**, haga clic en la **Configuración del servicio**. Revise las **opciones de comprobación**. Observe que las opciones **Mensaje de texto a teléfono**, **Notificación a través de aplicación móvil** y **de hardware** están habilitadas. Haga clic en **Guardar** y, a continuación, en **Cerrar**.

1. Cambie a la pestaña **usuarios**, haga clic en la entrada **aaduser1**, en el vínculo **Habilitar** y, cuando se le solicite, en **Habilitar Multi-Factor Auth**.

1. Observe que el valor de la columna **Estado de Multi-Factor Auth** para **aaduser1** ahora es **Habilitado**.

1. Haga clic en **aaduser1** y observe que, en este momento, también tiene la opción **Aplicar**. 
...
1. Con la entrada **aaduser1** seleccionada, haga clic en **Administrar configuración de usuario** y revise las opciones disponibles: 
...
1. Haga clic en **Cancelar** y vuelva a la pestaña del explorador que muestra la hoja **Multi-Factor Authentication \| Introducción** en Azure Portal.

1. En la sección **Configuración**, haga clic en **Alerta de fraude**.

1. En la hoja **Multi-Factor Authentication \| Alerta de fraude**, configure las siguientes opciones:
...
1. Vaya a Azure Portal e inicie sesión con la cuenta de usuario **aaduser1**. 
...
1. Cuando se le solicite, en el cuadro de diálogo **Se necesita más información**, haga clic en **Siguiente**.

    >**Nota**: La sesión del explorador se redirigirá a la página **Comprobación de seguridad adicional**.

1. En la página **Garantizar la seguridad de la cuenta**, seleccione el vínculo **Quiero configurar otro método** y, en la lista desplegable **¿Qué método quiere usar?** , seleccione **Teléfono** y **Confirmar**.

1. En la página **Garantizar la seguridad de la cuenta**, seleccione su país o región, escriba el número de teléfono móvil en el área **Indicar número de teléfono**, asegúrese de que la opción **Enviarme un código por mensaje de texto** está seleccionada y haga clic en **Siguiente**.
 
1. En la página **Garantizar la seguridad de la cuenta**, escriba el código que recibió en el mensaje de texto del teléfono móvil y haga clic en **Siguiente**.

1. En la página **Garantizar la seguridad de la cuenta**, asegúrese de que la comprobación se ha realizado correctamente y haga clic en **Siguiente**.

1. En la página **Garantizar la seguridad de la cuenta**, haga clic en **I want to use a different method** (Quiero utilizar otro método), seleccione **Correo electrónico** en la lista desplegable, haga clic en **Confirmar**, proporcione la dirección de correo electrónico que quiere usar y haga clic en **Siguiente**. Una vez que reciba el correo electrónico correspondiente, identifique el código en el cuerpo del correo electrónico, proporciónelo y, a continuación, haga clic en **Listo**.

1. Cuando se le pida, cambie la contraseña. Asegúrese de registrar la contraseña nueva.

1. Compruebe que ha iniciado sesión correctamente en Azure Portal.

1. Cierre la sesión de **aaduser1** y cierre la ventana del explorador InPrivate.
...
1. En la hoja **AdatumLab500-04**, en la sección **Administrar**, haga clic en **Seguridad**.

1. En la hoja **Seguridad \| Introducción**, en la sección **Proteger**, haga clic en **Acceso condicional**.

1. En la hoja **Acceso condicional \| Directivas**, haga clic en **+ Nueva directiva**. 

1. En la hoja **Nuevo**, configure las siguientes opciones:

   - En el cuadro de texto **Nombre**, escriba **AZ500Policy1**.
    
   - Haga clic en **Usuarios y grupos**, active la casilla **Usuarios y grupos** y, en la hoja **Seleccionar**, haga clic en **aaduser2** y en **Seleccionar**.
...
1. En la nueva ventana del explorador, vaya a Azure Portal e inicie sesión con la cuenta de usuario **aaduser2**.
...
1. En la página **Garantizar la seguridad de la cuenta**, haga clic en **Listo**.

1. Cuando se le pida, cambie la contraseña. Asegúrese de registrar la contraseña nueva.

1. Compruebe que ha iniciado sesión correctamente en Azure Portal.

1. Cierre la sesión de **aaduser2** y cierre la ventana del explorador InPrivate.
...
1. De nuevo en la ventana del explorador que muestra Azure Portal, vuelva a la hoja **AdatumLab500-04** del inquilino de Azure Active Directory.

1. En la hoja **AdatumLab500-04**, en la sección **Administrar**, haga clic en **Seguridad**.

1. En la hoja **Seguridad \| Introducción**, en la sección **Proteger**, haga clic en **Acceso condicional**.

1. En la hoja **Acceso condicional \| Directivas**, haga clic en los puntos suspensivos junto a **AZ500Policy1**, en **Eliminar** y, cuando se le pida confirmación, haga clic en **Sí**.
...
1. En la hoja **Seguridad \| Introducción**, en la sección **Proteger**, haga clic en **Identity Protection**.

1. En la hoja **Identity Protection \| Información general**, revise las opciones **Proteger**, **Informar** y **Notificar**. 
...
1. Configure la **Directiva de corrección de riesgos de usuario** con las siguientes opciones: 
...
1. Configure la **Directiva de corrección de riesgos de inicio de sesión** con las siguientes opciones: 
...
1. En la hoja **Máquinas virtuales**, haga clic en la entrada **az500-04-vm1**. 

1. En la hoja **az500-04-vm1**, haga clic en **Conectar** y, en el menú desplegable, haga clic en **RDP**. 

1. Haga clic en **Descargar archivo RDP** y úselo para conectarse a la VM de Azure **az500-04-vm1** a través de Escritorio remoto. Cuando se le pida que se autentique, proporcione las credenciales siguientes:
...
1. Inicie **Internet Explorer**, haga clic en el icono de rueda de engranaje de la barra de herramientas y, en el menú desplegable, haga clic en **Seguridad** y, a continuación, en **Exploración de InPrivate**.

1. En la ventana InPrivate de Internet Explorer, vaya al proyecto del Navegador Tor en [ **https://www.torproject.org/projects/torbrowser.html.en** ](https://www.torproject.org/projects/torbrowser.html.en).

1. Descargue e instale la versión para Windows del Navegador Tor con la configuración predeterminada. 

1. Una vez completada la instalación, inicie el Navegador Tor, use la opción **Conectar** de la página inicial y vaya al Panel de acceso de la aplicación en [ **https://myapps.microsoft.com** ](https://myapps.microsoft.com).

1. Cuando se le solicite, intente iniciar sesión con la cuenta **aaduser3**. 
...
1. Use la opción **Cerrar sesión e iniciar sesión con otra cuenta** para iniciar sesión con la cuenta **aaduser1** que creó y configuró para la autenticación multifactor anteriormente en este laboratorio.
...
1. Use la opción **Comprobar** y especifique si desea comprobar su identidad mediante un mensaje de texto o una llamada.

1. Complete la comprobación y asegúrese de que ha iniciado sesión correctamente en el Panel de acceso de la aplicación.

1. Cierre la sesión de RDP. 
...
1. En la hoja **Seguridad \| Introducción**, en la sección **Informes**, haga clic en **Usuarios de riesgo**. 

1. Revise el informe e identifique las entradas que hacen referencia a la cuenta de usuario **aaduser3**.

1. En la hoja **Seguridad \| Introducción**, en la sección **Informes**, haga clic en **Inicios de sesión de riesgo**. 

1. Revise el informe e identifique las entradas correspondientes al inicio de sesión con la cuenta de usuario **aaduser3**.

1. En **Informes**, haga clic en **Detecciones de riesgos**.

1. Revise el informe e identifique las entradas que representan el inicio de sesión desde la dirección IP anónima generada por el Navegador Tor. 
...
1. En la hoja **Identity Protection \| Información general**, haga clic en **Directiva de riesgo de usuario**.

1. En la hoja **Identity Protection \| Directiva de riesgo de usuario**, establezca **Aplicar directiva** en **Desactivado** y, a continuación, haga clic en **Guardar**.

1. En la hoja **Identity Protection \| Directiva de riesgo de usuario**, haga clic en **Directiva de riesgo de inicio de sesión**.

1. En la hoja **Identity Protection \| Directiva de riesgo de inicio de sesión**, establezca **Aplicar directiva** en **Desactivado** y, a continuación, haga clic en **Guardar**.
...
1. En la hoja **az500-04-vm1**, haga clic en **Detener** y, cuando se le pida confirmación, haga clic en **Aceptar**. 
